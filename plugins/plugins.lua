...
{ name = "udcd_uvc by xerpi v1.2", path = "udcd_uvc.skprx", section = "KERNEL",  path2 = false, section2 = false, config = false, version = "0002", desc = INSTALLP_DESC_UDCDUVC, },
...
{ name = "VitaGrafix by Electry v4.0 2019 Edition", path = "vitagrafix.suprx", section = "ALL",  path2 = "ioplus.skprx", section2 = "KERNEL", config = "config.txt", configpath = "ux0:data/VitaGrafix/", version = "0002", desc = INSTALLP_DESC_VITAGRAFIX, },-- Need kuio.skprx
