...
{ name = "VitaGrafix by Electry v4.0 alpha", path = "vitagrafix.suprx", section = "ALL",  path2 = "ioplus.skprx", section2 = "KERNEL", config = "config.txt", configpath = "ux0:data/VitaGrafix/", version = "0002", desc = INSTALLP_DESC_VITAGRAFIX, },-- Need kuio.skprx
