...
CHINESE_S["INSTALLP_DESC_UDCDUVCO"] =					"(适用于 OLED 机型) 使你能在关闭屏幕的情况下将 Vita 屏显内容流式传输到电脑上."
CHINESE_S["INSTALLP_DESC_UDCDUVCL"] =					"(适用于 LCD 机型) 使你能在关闭屏幕的情况下将 Vita 屏显内容流式传输到电脑上."
