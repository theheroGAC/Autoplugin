...
ITALIAN["UPDATE_VITACHEAT_DB_WRITE"] =					       "I file verranno sovrascritti!"
...
ITALIAN["INSTALLP_DESC_NOPSMWHITE"] =					"Disabilita la Whitelist della PSTV per i giochi PSM"
ITALIAN["INSTALLP_DESC_ANALOGSTICK"] =					"Plugin per disattivare completamente la levetta analogica della PSVita"
ITALIAN["INSTALLP_DESC_CIDSPOOF"] =					"Spoof del CID (ConsoleID) su PSVITA(Potrebbe essere utilizzato per sbannare la console dal PSN)"
...
ITALIAN["INSTALLP_DESC_BOOTSPLASHDONE"] =				"boot_splash.bin CREATO CON SUCCESSO !!!"
...
ITALIAN["INSTALLP_DESC_ITLSENSO"] =					"Aggiunge il TLS v1.2 ai dispositivi con Enso abilitato (richiede il vpk dell'applicazione)."
ITALIAN["INSTALLP_DESC_TROPHAX"] =						"Sbloccatore dei trofei universale per PSVITA."
