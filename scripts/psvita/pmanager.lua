...
function pluginsmanager()
	...
	while true do
		...
		screen.print(480,18,UNINSTALLP_TITLE,1.2,color.white, 0x0, __ACENTER)
		...
		if not tai[partition].exist then screen.print(480,270,UNINSTALLP_NOCONFIG_FOUND..locations[partition],1.3,color.red, 0x0, __ACENTER)
			...
			screen.print(30,450,UNINSTALLP_PLUGIN,1,color.white,color.black,__ALEFT)

			screen.print(10,475,UNINSTALLP_LEFTRIGHT_SECTION,1,color.white,color.black,__ALEFT)

			if buttonskey2 then buttonskey2:blitsprite(5,498,2) end
			if buttonskey2 then buttonskey2:blitsprite(35,498,3) end
			screen.print(70,500,INSTALLP_LR_SWAP,1,color.white,color.black,__ALEFT)
