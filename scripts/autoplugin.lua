...
{ name = "udcd_uvc by xerpi v1.0", path = "udcd_uvc.skprx", section = "KERNEL",  path2 = false, section2 = false, config = false, desc = INSTALLP_DESC_UDCDUVC, },
...
{ name = "VitaGrafix by Electry v2.2 ", path = "vitagrafix.suprx", section = "ALL",  path2 = "kuio.skprx", section2 = "KERNEL", config = "config.txt", configpath = "ux0:data/VitaGrafix/", desc = INSTALLP_DESC_VITAGRAFIX, },-- Need kuio.skprx
